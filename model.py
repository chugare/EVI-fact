...
class gated_evidence_fact_generation:
    ...
    def gated_choose(self, multi_states, evid_len, evid_count, context_vec):
        ...
        _, _, _, gate_value = tf.while_loop(lambda i, multi_states, context_vec, gate_value: i < evid_len[i], _step,
                                            [i, multi_states, context_vec, gate_value], name='get_gate_value_loop')
